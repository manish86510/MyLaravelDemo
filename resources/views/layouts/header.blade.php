<!DOCTYPE html>
<head>
	<title>Incredible | @yield('title')</title>
	<meta charset="utf-8">
...
<body class="header-fixed header-fixed-space">
	<div class="wrapper">
				...
				<div class="container">
					...
					<div class="menu-container">
						...
						<div class="navbar-brand">
							<a href="index.html">
								<img class="shrink-logo" src=" img/logo1-default.png" alt="Logo">
							</a>
						</div>
						<!-- ENd Navbar Brand -->
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown active">
									...
									<ul class="dropdown-menu">
										...
										<li class="active"><a href="page_home14.html">Option 6: Home Incredible</a></li>
									...
									<ul class="dropdown-menu">
										...
										<li class="dropdown-submenu">
											...
											<ul class="dropdown-menu no-bottom-space">
												<li><a href="index-2.html">Sub Level 2</a></li>
												<li class="dropdown-submenu">
													<a href="javascript:void(0);">Sub Level 2</a>
													<ul class="dropdown-menu">
														<li><a href="index-2.html">Sub Level 3</a></li>
														<li><a href="index-2.html">Sub Level 3</a></li>
														<li><a href="index-2.html">Sub Level 3</a></li>
														<li><a href="index-2.html">Sub Level 3</a></li>
													</ul>
		...
		<div class="container content-md">
			<div class="row">
				<div class="col-md-6">
					<h2 class="title-v2">WE ARE Techlopers</h2>
				...
				<div class="col-md-6">
					<img class="img-responsive" src=" img/mockup/mockup1.png" alt="">
				</div>
			</div>
		</div>
		<!-- End About Info -->
		...
		<div class="container content-sm">
			...
			<div class="row team-v4">
				<div class="col-md-3 col-sm-6 md-margin-bottom-50">
					<img class="img-responsive" src="img/team/img15-md.jpg" alt="">
				...
				<div class="col-md-3 col-sm-6 md-margin-bottom-50">
					<img class="img-responsive" src=" img/team/img31-md.jpg" alt="">
				...
				<div class="col-md-3 col-sm-6 sm-margin-bottom-50">
					<img class="img-responsive" src=" img/team/img18-md.jpg" alt="">
					<span>John Doe</span>
				...
				<div class="col-md-3 col-sm-6">
					<img class="img-responsive" src=" img/team/img37-md.jpg" alt="">
			...
			<div class="container content-sm">
				...
				<div class="testimonials-v6 testimonials-wrap">
					<div class="row margin-bottom-50">
						<div class="col-md-6 md-margin-bottom-50">
							<div class="testimonials-info rounded-bottom">
								<img class="rounded-x" src=" img/testimonials/img5.jpg" alt="">
						...
						<div class="col-md-6">
							<div class="testimonials-info rounded-bottom">
								<img class="rounded-x" src=" img/testimonials/img6.jpg" alt="">
								<div class="testimonials-desc">
									<p>Donec quis lorem sit amet nibh tempor porttitor non eu justo. Fusce iaculis scelerisque nibh at rhoncus. Aliquam blandit.</p>
					...
					<div class="row margin-bottom-20">
						<div class="col-md-6 md-margin-bottom-50">
							<div class="testimonials-info rounded-bottom">
								<img class="rounded-x" src=" img/testimonials/img3.jpg" alt="">
								<div class="testimonials-desc">
									<p>Donec quis lorem sit amet nibh tempor porttitor non eu justo. Fusce iaculis scelerisque nibh at rhoncus. Aliquam blandit.</p>
						...
						<div class="col-md-6">
							<div class="testimonials-info rounded-bottom">
								<img class="rounded-x" src=" img/testimonials/img2.jpg" alt="">
								<div class="testimonials-desc">
									<p>Donec quis lorem sit amet nibh tempor porttitor non eu justo. Fusce iaculis scelerisque nibh at rhoncus. Aliquam blandit.</p>
	...
	<script src=" plugins/master-slider/masterslider/jquery.easing.min.js"></script>
...
<!-- Mirrored from htmlstream.com/preview/unify-v1.9.9/page_home14.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jun 2017 00:25:34 GMT -->
</html>
